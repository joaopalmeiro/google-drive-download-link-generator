<script>
  ...
  $: downloadClasses =
    downloadUrl === undefined
      ...
      : "text-sendstack-onyx border-sendstack-onyx bg-gray-50";
</script>
...
>
  ...
  <main class="max-w-screen-sm w-full my-auto">
    <div class="p-9 bg-gray-50 rounded-3xl">
      <!-- https://tailwindcss.com/docs/installation -->
      <h1 class="text-sendstack-onyx text-xl tracking-tight font-bold">
        Google Drive download link generator
      </h1>

      <p class="mt-1 text-base text-sendstack-gemstone">
        Paste a file share link and get a direct download link.
      </p>
    ...
    <div class="flex flex-row items-center gap-x-4 mt-4 px-9">
